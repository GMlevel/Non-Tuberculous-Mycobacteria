...
# Define directories
base_dir="/storage/work/mnk5428/Dr.Zack/Assemblies"
abricate_output_base_dir="/storage/work/mnk5428/Dr.Zack/abricate_output"
...
# Iterate over directories containing assembly files in FASTA format
for assembly_file in "$base_dir"/*.fasta; do
